        ...
        try:
            ...
            if os.path.exists(model_path):
                ...
                possible_paths = [
                    ...
                    os.path.join(os.path.dirname(__file__), "..", "..", "models", "model_logistic.pkl"),
                    os.path.join(os.path.dirname(sys.executable), "models", "model_logistic.pkl") if getattr(sys, 'frozen', False) else None
                ]
                ...
                if not found:
                    raise FileNotFoundError("Model tidak ditemukan di semua path yang dicoba!")
                    
        except Exception as e:
            messagebox.showerror("Error Model", f"Gagal load model:\n{e}\n\nPastikan folder models ada di folder aplikasi!")
            self.model = None
